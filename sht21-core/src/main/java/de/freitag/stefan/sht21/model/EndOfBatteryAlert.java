...
/**
 * The end of battery alert is activated when the battery power falls below 2.25 V. Value of the
 * status bit:
 *
 * <ul>
 *   <li>0: VDD greater than 2.25 Volt
 *   <li>1: VDD less than 2.25 Volt
 * </ul>
 */
@Getter
public enum EndOfBatteryAlert {
  ...
  /**
   * Returns the end Of battery alert status (alert on/off) for the given {@code eobByte}.
   *
   * @param eobByte Byte to evaluate.
   * @return EndOfBattery status (alert on/off) for the given {@code eobByte}.
   */
